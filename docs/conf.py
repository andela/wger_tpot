...
# relative to the documentation root, use os.path.abspath
# to make it absolute, like shown here.sys.path.insert(0, os.path.abspath('.'))
...
# place at the top of the title page. latex_logo = None
...
texinfo_documents = [
    ('index', 'wgerWorkoutManager', u'wger Workout Manager Documentation',
     u'Roland Geider', 'wgerWorkoutManager', 'One line\
