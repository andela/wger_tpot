...
def create_demo_entries(user):
    ...
    for reps in (8, 10, 12):
        for i in range(1, 8):
            log = WorkoutLog(user=user,
                             ...
                             date=datetime.date.today() - datetime.timedelta(weeks=i))  # noqa
    ...
    setting_list.append(Setting(set=day_set, exercise=exercise, reps=10,
                                order=1))
    ...
    setting_list.append(Setting(set=day_set, exercise=exercise, reps=40,
                                order=2))
    setting_list.append(Setting(set=day_set, exercise=exercise,
                                reps=99, order=3))
    ...
    workout2 = Workout(user=user, comment=_('Placeholder workout nr {0} for\
                                            schedule').format(1))
    workout2.save()
    workout3 = Workout(user=user, comment=_('Placeholder workout nr {0} for \
                                             schedule').format(2))
    workout3.save()
    workout4 = Workout(user=user, comment=_('Placeholder workout nr {0} for \
                                             schedule').format(3))
    workout4.save()
